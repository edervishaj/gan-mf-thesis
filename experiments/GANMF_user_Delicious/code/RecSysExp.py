...
def main(arguments):
    ...
    list_experiments = ['TopPop', 'Random', 'PureSVD', 'NMF', 'ALS', 'BPR', 'CFGAN', 'GANMF', 'DisGANMF', 'SLIM']
    ...
    slimelatic_fit_params = [d.name for d in slimelastic_dimensions]



    cfgan_dimensions = [
        Categorical([300], name='epochs'),
        Integer(1, 3, prior='uniform', name='d_steps', dtype=int),
        Integer(1, 3, prior='uniform', name='g_steps', dtype=int),
        Integer(1, 3, prior='uniform', name='d_layers', dtype=int),
        Integer(1, 3, prior='uniform', name='g_layers', dtype=int),
    ...
    dict_rec_classes['SLIM'] = SLIMElasticNetRecommender
    ...
    dict_dimensions['SLIM'] = slimelastic_dimensions
    ...
    dict_fit_params['SLIM'] = slimelatic_fit_params
